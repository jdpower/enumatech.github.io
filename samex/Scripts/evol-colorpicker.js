...
$.widget( "evol.colorpicker", {
			...
			if(this._palette===null){
				this._palette=this.element.next()
					...
					.on('click',function(evt){
					    evt.stopPropagation();
					    //this.element.trigger('colorpicker.show', true);
						return false;
					});
				this._bindColors();
				var that=this;
	...
	hidePalette: function (byclick) {
	    if (this.element) this.element.trigger('colorpicker.hide');
	    if (this._isPopup && this._palette) {
			...
			this._palette.off('mouseover click', 'td,.evo-transparent')
				.fadeOut(function () {
					...
					//this.element.trigger('colorpicker.show', false);
				})
